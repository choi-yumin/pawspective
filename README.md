...
**Students:** Makhabbat (ID: 20240935) and Yu Min (ID: 20220899)
**Department:** Industrial Design, KAIST  
**Contact:** [mako1004@kaist.ac.kr](mailto:mako1004@kaist.ac.kr)  
**Links:** [Git Repository](https://github.com/choi-yumin/pawspective) | [Video Demo](https://youtu.be/vDffRuz51hA)
...
- **GSAP animation Engine:** manipulating z-dog components
- **Backend Server:** Netlify
- **AI API KEY:** OPENAI key used

# Resources Used

Inspiration from Bee: https://codepen.io/dabalog/pen/xxqjNyX.

Various AI tools like Claude and Gemini were widely used during the creation of this website.
